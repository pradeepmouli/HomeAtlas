...
- **Accessory**: A physical or bridged HomeKit device with name, identifier, reachability, category, and services
...
- Velox compatibility (if applicable) follows the same patterns as React Native native modules
