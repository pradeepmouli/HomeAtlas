...
**Created**: 2025-11-11
**Status**: Draft
**Input**: User description: "Finalize HomeAtlas branding across docs and tooling, ensure the SwiftPM module ships as `HomeAtlas`, and implement a deterministic snapshot export covering Home/Room/Accessory/Service/Characteristic graphs."
...
A developer can rely on the finalized naming: brand/repo and module exported as `HomeAtlas`, docs and examples consistently referencing the new name, and tooling documentation clarifying extractor/generator usage, with clear migration guidance from legacy `SwiftHomeKit` terminology.
...
- **FR-005**: The rebrand MUST update visible naming in documentation and developer entry points to “HomeAtlas” (brand/repo and module) and clarify CLI/tool usage, with a migration note from legacy terminology.
