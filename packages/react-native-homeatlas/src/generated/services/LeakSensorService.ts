...
/**
 * Service interface for LeakSensor
 */
export interface LeakSensorService extends Service {
  /** Service type identifier */
  readonly type: 'HMServiceTypeLeakSensor';
   ...
   */
  readonly leakdetected: Characteristic<number>;
