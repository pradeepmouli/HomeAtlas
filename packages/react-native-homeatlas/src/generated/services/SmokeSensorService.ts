...
/**
 * Service interface for SmokeSensor
 */
export interface SmokeSensorService extends Service {
  /** Service type identifier */
  readonly type: 'HMServiceTypeSmokeSensor';
   ...
   */
  readonly smokedetected: Characteristic<number>;
